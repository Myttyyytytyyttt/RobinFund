...
export const PK = [
  ...
  "0x92db14e403b83dfe3df233f83dfa3a0d7096f21ca9b0d6d6b8d88b2b4ec1564e", // 6 LP3 (será revocado)
...
export const [DEPLOYER, SIGNER, KEEPER, MANAGER, LP1, LP2, LP3, TREASURY, MULTISIG] = [0, 1, 2, 3, 4, 5, 6, 7, 8];
